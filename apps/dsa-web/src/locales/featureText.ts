...
export const BACKTEST_TEXT = {
  zh: {
    ...
    strategySelect: '模拟策略',
    strategyPeriod: '模拟周期',
    runStrategyBacktest: '模拟策略',
    strategyRunning: '模拟中...',
    strategyNoCode: '请先输入股票代码，再运行历史策略模拟。',
    strategyResultTitle: '历史策略模拟结果',
    strategyBars: 'K线数',
    strategyTrades: '交易数',
    strategyTotalReturn: '策略收益',
    strategyBuyHoldReturn: '买入持有',
    strategyMaxDrawdown: '最大回撤',
    strategyFinalEquity: '期末资金',
    strategyDataRange: '数据区间：{start} 至 {end} · 来源：{source}',
    strategyNoTrades: '区间内没有触发交易。可以换策略、拉长日期范围，或换一只有更长历史数据的股票。',
    strategyTradesTitle: '交易明细',
    strategyEntryDate: '买入日',
    strategyExitDate: '卖出日',
    strategyEntryPrice: '买入价',
    strategyExitPrice: '卖出价',
    strategyReturn: '收益',
    strategyExitReason: '卖出原因',
    exitReasonStopLoss: '止损',
    exitReasonTakeProfit: '止盈',
    exitReasonSignalExit: '信号退出',
    exitReasonPeriodEnd: '区间结束',
    exitReasonAtrStop: 'ATR止损',
    exitReasonTrailingTakeProfit: '移动止盈',
    exitReasonRsiOverheat: 'RSI过热',
    exitReasonUpthrust: '上冲回落',
    ...
    pendingMetricsTitle: '等待数据成熟',
    pendingMetricsDescription: '当前只有 {count} 条待成熟样本，还没有足够的未来交易日来统计胜率和收益。你可以继续等待，或把结束日期往前调。',
    runFinishedWaitingTitle: '回测已结束：等待未来行情成熟',
    runFinishedWaitingDescription: '不是卡住；系统已处理并保存结果，但 {days} 日窗口需要分析日之后足够的交易日，当前只能标记为数据不足。',
    resultDiagnosticTitle: '当前没有正在运行的回测任务',
    resultDiagnosticBody: '这批结果已经评估完毕；样本的分析日是 {date}，{days} 日窗口需要之后 {days} 个交易日才能计算胜率、收益和方向匹配。',
    resultDiagnosticEvaluatedAt: '最后评估：{time}',
    resultDiagnosticTip: '想立刻看到可完成样本，可以点“1 日验证”，或把结束日期提前到更早的历史分析。',
  ...
  en: {
    ...
    aiAuditMode: 'AI audit backtest',
    strategyMode: 'Historical strategy simulation',
    strategySelect: 'Strategy',
    strategyPeriod: 'Period',
    runStrategyBacktest: 'Simulate strategy',
    strategyRunning: 'Simulating...',
    strategyNoCode: 'Enter a stock code before running a historical strategy simulation.',
    strategyResultTitle: 'Historical strategy simulation',
    strategyBars: 'Bars',
    strategyTrades: 'Trades',
    strategyTotalReturn: 'Strategy return',
    strategyBuyHoldReturn: 'Buy and hold',
    strategyMaxDrawdown: 'Max drawdown',
    strategyFinalEquity: 'Final equity',
    strategyDataRange: 'Data range: {start} to {end} · Source: {source}',
    strategyNoTrades: 'No trades were triggered in this range. Try another strategy, a longer range, or a stock with more history.',
    strategyTradesTitle: 'Trades',
    strategyEntryDate: 'Entry',
    strategyExitDate: 'Exit',
    strategyEntryPrice: 'Entry price',
    strategyExitPrice: 'Exit price',
    strategyReturn: 'Return',
    strategyExitReason: 'Exit reason',
    exitReasonStopLoss: 'Stop loss',
    exitReasonTakeProfit: 'Take profit',
    exitReasonSignalExit: 'Signal exit',
    exitReasonPeriodEnd: 'Period end',
    exitReasonAtrStop: 'ATR stop',
    exitReasonTrailingTakeProfit: 'Trailing take profit',
    exitReasonRsiOverheat: 'RSI overheat',
    exitReasonUpthrust: 'Upthrust',
    ...
    pendingMetricsTitle: 'Waiting for maturity',
    pendingMetricsDescription: 'There are only {count} pending samples right now. The engine still needs more future trading days before it can compute win rate and returns. You can keep waiting or move the end date earlier.',
    runFinishedWaitingTitle: 'Backtest finished: waiting for future bars',
    runFinishedWaitingDescription: 'It is not stuck; the system processed and saved the result, but the {days}-day window needs enough trading days after the analysis date, so it is marked as insufficient data for now.',
    resultDiagnosticTitle: 'No backtest task is currently running',
    resultDiagnosticBody: 'These results have already been evaluated. The sample analysis date is {date}; a {days}-day window needs {days} later trading days before win rate, return, and direction match can be computed.',
    resultDiagnosticEvaluatedAt: 'Last evaluated: {time}',
    resultDiagnosticTip: 'To see completed samples immediately, use 1D validation or move the end date earlier.',
